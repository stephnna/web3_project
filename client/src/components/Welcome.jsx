...
const Welcome = () => {
  ...
  return(  
    <div className="flex md:flex-row flex-col items-start justify-between md:pl-20 py-12 px-4">
      <div className="flex flex-1 justify-start flex-col">
        <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
          Transfer Crypto <br /> across the globe
        </h1>
        <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
        Explore the world of cryptocurrencies and use Vild to purchase and sell them easily.</p>
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10">
          <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism">
             ...
             <div>
              <p className="text-white font-white font-sm">
